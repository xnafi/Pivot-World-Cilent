...
const Login = () => {
    return (
        <div className="bg-white dark:bg-gray-900 h-full md:h-screen w-full px-8 bgLogin bg-center bg-fixed bg-cover bg-no-repeat flex flex-col md:flex-row justify-center items-center" >
            <div className="flex bg-white flex-col max-w-md p-6 rounded-md sm:p-10 dark:bg-gray-900 dark:text-gray-100 mt-32">
